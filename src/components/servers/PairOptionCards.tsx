...
export function PairOptionCards({ options, onChange, sourceServer, targetServer, disabled = false, lockOrganization = false, hideOrganization = false, column }: PairOptionCardsProps) {
  ...
  const repositorySelection = <DisabledCards disabled={disabled}>
    <GitHubConfigForm part="selection" hideStarLists config={githubConfig} setConfig={setGitHubConfig} mirrorOptions={mirrorOptions} setMirrorOptions={setMirrorOptions} advancedOptions={advancedOptions} setAdvancedOptions={setAdvancedOptions} giteaConfig={giteaConfig} setGiteaConfig={setGiteaConfig} />
  </DisabledCards>;
